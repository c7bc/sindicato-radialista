...
const defaultContent: FooterContent = {
  description: "Representando e defendendo os direitos dos radialistas com força e dedicação.",
  navItems: [
    { label: "Início", href: "/" },
        ...
        <div className="mx-auto max-w-7xl px-6 py-6">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-xs text-gray-500">© {new Date().getFullYear()} Sindicato dos Radialistas. Todos os direitos reservados.</span>
            </div>
          </div>
        </div>
      </div>
